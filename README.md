...
- หน้า Home และ History สำหรับแสดงข้อมูลตัวอย่าง
  ...
  **การใช้งานเว็บเบื้องต้น**
  ...
  - ดูข้อมูลและจัดการรายการ:
    - หน้า `Home` จะแสดงยอดรวมเงินที่คงเหลือ, ยอดเงินที่ถูกถอน, รายละเอียดบัญชีเบื้องต้น และตารางยอดรวมรายการถอนเงินของแต่ละผู้ใช้ที่มีประวัติรายการถอนเงิน.
    - หน้า `History` จะแสดงตารางรายการถอนเงิน (`Withdrawaltable`).
    - คลิกปุ่ม "เพิ่ม" ในหน้า `History` เพื่อเปิด `AddDialog` และกรอกข้อมูล จากนั้นกดบันทึกเพื่อเพิ่มรายการถอนเงินใหม่.
